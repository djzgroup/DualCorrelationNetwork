...
parser.add_argument('--pretrained_3d', type=str, 
                    default='/mnt/data/hanfei/PyTorch-MFNet-master/network/pretrained/MFNet3D_Kinetics-400_72.8.pth',
                    help="load default 3D pretrained model.")
parser.add_argument('--resume-epoch', type=int, default=4,
                    help="resume train")
# optimization
...
parser.add_argument('--batch-size', type=int, default=32,
                    help="batch size")
parser.add_argument('--lr-base', type=float, default=0.004,
                    help="learning rate")
